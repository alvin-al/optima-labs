    ...
    <div className='sticky top-0 z-40 bg-white/80 backdrop-blur border-b border-slate-100'>
      <div className='max-w-6xl mx-auto px-4 py-3 flex items-center justify-between'>
        ...
        <nav className='hidden md:flex items-center gap-6 text-sm text-slate-600'>
          <a href='#optimize' className='hover:text-slate-900'>
            Optimize You
          </a>
...
function Hero() {
  return (
    <header className='max-w-6xl mx-auto px-4 py-10 sm:py-16'>
      <div className='grid md:grid-cols-2 gap-8 items-center'>
        <div className='space-y-6'>
          ...
          >
            Feel better, faster — 24/7 in‑home medical care
          </motion.h1>
          <p className='text-slate-600 text-lg max-w-xl'>
            IV therapy, vitamin injections, lab testing & rapid relief for Bali
            Belly, jet lag, hangover and more. A licensed nurse comes to your
            villa, hotel, or home.
          </p>
          <div className='flex flex-col sm:flex-row items-start gap-3'>
            <a
              ...
              target='_blank'
              rel='noreferrer'
              className='inline-flex items-center justify-center gap-2 rounded-lg bg-slate-900 hover:bg-black text-white px-5 py-3 text-base'
            >
              <MessageSquareText className='h-5 w-5' /> Book on WhatsApp{" "}
              <ArrowRight className='h-4 w-4' />
            </a>
            <div className='flex items-center gap-3 text-sm text-slate-600'>
              <span className='inline-flex items-center gap-1'>
                <ShieldCheck className='h-4 w-4 text-emerald-600' /> Licensed &
                insured
              </span>
              <span className='inline-flex items-center gap-1'>
                <Stethoscope className='h-4 w-4 text-emerald-600' /> Doctor
                oversight
              </span>
              <span className='inline-flex items-center gap-1'>
                <Clock className='h-4 w-4 text-emerald-600' /> 24/7 dispatch
              </span>
            </div>
          </div>
        </div>
        {/* Hero image */}
        <div
          className="relative aspect-[4/3] rounded-2xl bg-[url('https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?q=80&w=1600&auto=format&fit=crop')] bg-cover bg-center shadow-xl border border-slate-200"
          aria-label='Nurse preparing IV in a Bali villa'
        />
      </div>
    </header>
  );
